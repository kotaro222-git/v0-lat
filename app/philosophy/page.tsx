    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-xs tracking-[0.2em] text-neutral-400 uppercase">Philosophy</span>
          </div>
          <h1 className="text-[clamp(32px,5vw,56px)] font-bold tracking-[-0.02em] leading-[1.2] text-neutral-900">
      ...
      <section className="border-t border-neutral-200 py-20 px-6">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-8 h-[1px] bg-neutral-300"></div>
            <span className="text-xs tracking-[0.2em] text-neutral-400 uppercase">Message</span>
          </div>
          ...
          <div className="grid lg:grid-cols-[280px_1fr] gap-12 mt-12">
            <div>
              <div className="aspect-[3/4] bg-neutral-100 rounded-sm overflow-hidden">
                <img src="/ceo-portrait.jpg" alt="CEO" className="w-full h-full object-cover" />
              </div>
              <div className="mt-4">
                <p className="text-[10px] tracking-[0.15em] text-neutral-400 uppercase">CEO &amp; Founder</p>
                <p className="text-base font-bold text-neutral-900 mt-1">{"稲葉 幸太郎"}</p>
              </div>
            </div>
      ...
      <section className="border-t border-neutral-200 py-20 px-6">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-8 h-[1px] bg-neutral-300"></div>
            <span className="text-xs tracking-[0.2em] text-neutral-400 uppercase">Origin of Name</span>
          </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-[1200px] mx-auto text-center">
          <div className="flex items-center justify-center gap-4 mb-8">
            <div className="w-8 h-[1px] bg-neutral-300"></div>
            <span className="text-xs tracking-[0.2em] text-neutral-400 uppercase">Mission</span>
            <div className="w-8 h-[1px] bg-neutral-300"></div>
          </div>
      ...
      <section className="bg-neutral-900 py-20 px-6">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex items-center justify-center gap-4 mb-8">
            <div className="w-8 h-[1px] bg-neutral-600"></div>
            <span className="text-xs tracking-[0.2em] text-neutral-500 uppercase">Value</span>
            <div className="w-8 h-[1px] bg-neutral-600"></div>
          </div>
          <h2 className="text-[clamp(24px,3vw,32px)] font-bold text-white text-center mb-12">{"私たちの価値観"}</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { num: "01", title: "Be True", subtitle: {"jp": "純度を大切に"}, desc: {"jp": "純粋な意志でコトに向き合い、自らの内なる声に真っ直ぐに従うこと。"} },
              { num: "02", title: "Stay Kind", subtitle: {"jp": "優くあること"}, desc: {"jp": "相手を深く尊重し、共に歩むこと。巧拙は抱擁に勝かす。"} },
              { num: "03", title: "Build, Don't Decorate", subtitle: {"jp": "中身を大切に"}, desc: {"jp": "本当に価値のある本質を泥臭く積み上げること。見せかけの完成度より、実を伴う力強さを。"} },
            ].map((value) => (
              <div key={value.num} className="bg-neutral-800/50 rounded-lg p-8 relative overflow-hidden">
                <span className="absolute top-6 right-6 text-[64px] font-bold text-neutral-700/30 leading-none">{value.num}</span>
                <h3 className="text-xl font-bold text-white mb-1">{value.title}</h3>
                <p className="text-xs text-neutral-500 mb-4">{value.subtitle.jp}</p>
                <p className="text-sm text-neutral-400 leading-relaxed">{value.desc.jp}</p>
              </div>
            ))}
          </div>
        </div>
