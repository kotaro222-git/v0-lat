          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="flex items-center justify-center pt-6">
              <svg width="320" height="380" viewBox="0 0 680 520">
                ...
                <text x="382" y="67" fill="#3d3d3a" fontFamily="monospace" fontSize="12" opacity="0.6">90 N</text>
                <g opacity="0.9">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white text-neutral-900 rounded-2xl p-9 relative overflow-hidden min-h-[220px]">
              <div className="flex justify-between items-start mb-1">
                <div className="text-xl font-bold tracking-[-0.01em] relative z-10">Be True</div>
            ...
            <div className="bg-white text-neutral-900 rounded-2xl p-9 relative overflow-hidden min-h-[220px]">
              <div className="flex justify-between items-start mb-1">
                <div className="text-xl font-bold tracking-[-0.01em] relative z-10">Stay Kind</div>
            ...
            <div className="bg-white text-neutral-900 rounded-2xl p-9 relative overflow-hidden min-h-[220px]">
              <div className="flex justify-between items-start mb-1">
                <div className="text-xl font-bold tracking-[-0.01em] relative z-10">Build, Do Not Decorate</div>
