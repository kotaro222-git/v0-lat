...
const services = [
  {
    ...
    title: "DXソリューション",
    titleEn: "DX Solution",
    description: "End-to-end DX support from strategy to implementation",
  },
  {
    number: "02",
    title: "AIエージェント構築・運用",
    titleEn: "AI Agent Development",
    description: "Design, build, and operate AI agents tailored to your needs",
  },
  {
    number: "03",
    title: "AI社員派遣",
    titleEn: "AI Staff Dispatch",
    description: "Our optimized AI agents work as AI employees in your organization",
  },
  {
    number: "04",
    title: "プロダクト開発",
